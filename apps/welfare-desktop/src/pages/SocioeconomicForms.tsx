...
export default function SocioeconomicForms() {
  ...
  const loadForms = async () => {
    ...
    try {
      ...
      setError('Unable to load socioeconomic forms. Verify socioeconomic-form-service is running.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-3xl font-black text-campus-navy">
      ...
      <div className="mt-8 grid gap-8 xl:grid-cols-[430px_1fr]">
        <div className="rounded-[1.75rem] border border-white/70 bg-white/85 p-7 shadow-academic">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="block">
                ...
                <input
                  ...
                  onChange={(e) => setForm((prev) => ({ ...prev, familyIncome: e.target.value }))}
              ...
              <label className="block">
                ...
                <input
                  ...
                  onChange={(e) => setForm((prev) => ({ ...prev, familyMembers: e.target.value }))}
                  className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-campus-blue focus:ring-4 focus:ring-campus-blue/10"
                  required
                />
              </label>
            ...
            <label className="block">
              ...
              <input
                ...
                onChange={(e) => setForm((prev) => ({ ...prev, housingType: e.target.value }))}
                placeholder="RENTED"
                className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-campus-blue focus:ring-4 focus:ring-campus-blue/10"
                required
              />
            ...
            <label className="block">
              ...
              <textarea
                ...
                onChange={(e) => setForm((prev) => ({ ...prev, vulnerabilityFactors: e.target.value }))}
        ...
        <div className="rounded-[1.75rem] border border-white/70 bg-white/85 p-7 shadow-academic">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-black text-campus-navy">Form Management</h2>
            </div>
            <button
              type="button"
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-[1fr_auto_auto]">
            ...
            <button
              type="button"
              onClick={() => { setStudentSearch(''); void loadForms(); }}
              className="rounded-2xl bg-slate-100 px-5 py-3 text-sm font-bold text-slate-700 transition hover:bg-slate-200"
            >
              Reset
            </button>
                  ...
                  {isLoading ? (
                    ...
                    forms.map((item) => (
                      <tr key={item.id} className="align-top">
                        ...
                        <td className="px-5 py-4 text-slate-700">{item.employmentStatus}</td>
